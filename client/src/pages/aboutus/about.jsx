function Aboutpage(){
    return(<>
  <div className="w-auto h-auto bg-pink-200 border-cyan-400">

<div className="box-border pt-3 font-bold text-center text-black">Who are we</div>
<div className="box-border h-auto p-4 mx-12 mt-10 bg-gray-300 border-4 w-80">
    <div className="font-light">The word 'SARVAM' a Sanskrit word that stands for "Everything" or "Complete", represents to the totality of our strengths as a company - Infrastructure, Man power, Rich Experience, Extensive Product Range, Quality and undying passion to remain ahead of the times. All backed by our capable and experienced sales, Marketing, Back end Supporting, Service and Logistics team.
...
SARVAM SAFETY is your one stop solution provider for "Life Safety Equipment", with vast product range that encompasses complete Protection to Head , Eye , Hearing , Respiratory , Hand , Body , Foot and other safety Equipment like - Fall , First aid , Confined Space , Electrical safety , Gas detectors , Breathing Apparatus , Safety cans & cabinets , Spill kits & sorbents, Fire & Welding blankets , etc.</div>
</div>
<p className="px-5 py-5 mx-5 font-bold text-black">Our consistent practices of strict adherence to quality, prompt delivery and efficient service have enabled us to be proud channel partner for various reputed safety Equipment Manufacturers and to name the few:</p>
<div className="px-10">
    <div className="h-auto mt-1 bg-white border-4 w-300 ">
      ...
      <div className="h-auto mt-5 bg-white border-4 w-300 ">
...
<p>* Lalan Rubber – Srilanka - Gloves</p>
      ...
      <div className="box-border h-auto p-4 mx-12 mt-10 bg-gray-300 border-4 w-80">
        	<p className="">Sarvam Safety is headquartered in Chennai, with branch offices at Coimbatore, Madurai, Pondicherry and Cochin. We also have distribution reach across India to cater to the safety needs of our valued customers, wherever they may be located.</p>

<p className="">Here with this letter please find enclosed our company Bank, GST and other details and we request you to register our company name in your vendor list and encourage us your valuable business.</p>

<p className="">Thanking you and anticipating your support which shall have our best and prompt attention at all times.</p>
      </div>
...
<div className="">
		<div className="flex ml-10">
			<div className="flex pt-5 pl-20">
				<div className=""><img src="https://sarvamsafety.com/image/catalog/about/rich.png" alt="imGE1" ></img></div>
				<div className="p-6 pl-20 font-bold">RICH EXPERIENCE</div>
			</div>
			<div className="flex pt-5 pl-20 ml-12">
				<div className="pl-10"><img src="https://sarvamsafety.com/image/catalog/about/Quality.png" alt="imGE2" ></img></div>
				<div className="p-6 pl-20 font-bold">Quality</div>
			</div>
	    </div>
		<div className="flex ml-10">
			<div className="flex pt-5 pl-20">
				<div className=""><img src="https://sarvamsafety.com/image/catalog/about/Extensive.png" alt="imGE3" ></img></div>
				<div className="p-6 pl-20 font-bold">EXTENSIVE PRODUCT RANGE</div>
			</div>
			<div className="flex pt-5 pl-20">
				<div className="table3"><img src="https://sarvamsafety.com/image/catalog/about/Efficiency.png" alt="imGE4" ></img></div>
				<div className="p-6 pl-20 font-bold">EFFICIENCY</div>
			</div>
		</div>
	</div>
	<div className="pt-8 font-bold">Happy customer says</div>
	<div className="">
